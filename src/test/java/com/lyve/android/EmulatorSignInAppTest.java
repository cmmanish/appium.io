...
public class EmulatorSignInAppTest extends AbstractAppiumBaseClass {
    final private static Logger log = Logger.getLogger(EmulatorSignInAppTest.class);
    ...
    public void testSignInAndroid() {
        ...
        String email = "mmadhusoodan+120@lyveminds.com";
